...
The 0.20.0 runtime set contains 50 approved derivatives grouped under these source/license records:

- 10 assets from `Space Shooter Pack – 2D Pixel Art Ships, Enemies, VFX & Music/license.txt` (`approved_cc0`).
- 29 assets from `SpaceShooter/license.txt` (`approved_cc0`).
- 5 assets from `Pixel Art Spaceships full/license.txt` (`approved_cc0`).
...
The exact stable IDs, source paths, SHA-256 hashes, runtime paths, and review state are authoritative in the generated manifest. None of the 50 runtime records is marked as requiring attribution.
