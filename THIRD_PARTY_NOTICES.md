...
The 0.20.0 runtime set contains 22 approved derivatives grouped under these source license records:
...
The exact stable IDs, source paths, SHA-256 hashes, runtime paths, and review state are authoritative in the generated manifest. None of the 22 records is marked as requiring attribution.
